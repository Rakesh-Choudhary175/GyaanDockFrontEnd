    ...
    const response = await fetch(
      "https://judge0-ce.p.rapidapi.com/submissions",
      {
        ...
        headers: {
          ...
          "x-rapidapi-key":
            "49fb9d4be1mshcb3e33ee4a39d2ap1c1117jsne33fe00df182", // Get yours for free at https://rapidapi.com/judge0-official/api/judge0-ce/
  ...
  updateScore = () => {
    ...
    if (localStorage.getItem("userScore") != null) {
      let score =
        ...
        parseInt(this.state.question.score);
