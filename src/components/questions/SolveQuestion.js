...
function SolveQuestion() {
  ...
  function showComments() {
    if (showQuestion !== false) SetIsQuestion(false);
  }

  function showQuestion() {
    if (showQuestion !== true) SetIsQuestion(true);
  }
      ...
      <>
        <Card>
          <Card.Body>
            ...
            <Card.Text>{question.input_format}</Card.Text>
            <Card.Title>Output Format</Card.Title>
            <Card.Text>{question.output_format}</Card.Text>
        ...
        <Card className="questionData">
          <Card.Header>
            <Nav justify variant="tabs" defaultActiveKey="/home">
              <Nav.Item>
                <Nav.Link eventKey="questionData" onClick={showQuestion}>
                  Description
                </Nav.Link>
              </Nav.Item>
              <Nav.Item>
                <Nav.Link eventKey="Comment" onClick={showComments}>
                  Comment
                </Nav.Link>
              </Nav.Item>
            </Nav>
          ...
          <Card.Body>
            {
              isQuestion === true ? QuestionDetails() : <Comment />
              // QuestionDetails()
            }
          </Card.Body>
        </Card>
  ...
  return (
    <>
      ...
      <CardGroup>
        <Card border="white">
          <Card.Body>{fetchQuestionDetails()}</Card.Body>
        </Card>
        <Card border="white">
          <Card.Body>
            <Compiler />
